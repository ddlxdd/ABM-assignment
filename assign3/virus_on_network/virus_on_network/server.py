...
def network_portrayal(G):
    ...
    def node_size(agent):
        if hasattr(agent, 'is_superspreader') and agent.is_superspreader:
            return 10
        return 6
...
model_params = {
    ...
    "degree_influence": mesa.visualization.Slider(
        "Degree Influence",
        value=0.01,
        min_value=0.0,
        max_value=0.1,
        step=0.01,
        description="Influence of Network Degree on Infection Probability"
    ),
}
